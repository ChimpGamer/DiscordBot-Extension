        ...
        return discordBot.networkManager.cloudCommandManager.commandManager.commandBuilder(name, *aliases)
            ...
            .handler { context ->
                ...
                if (Cooldown.isInCooldown(player.uuid, name)) {
                    player.sendMessage(discordBot.messages.getString(MCMessage.SUGGESTION_COOLDOWN)
                ...
                var jsonMessageEmbed = JsonMessageEmbed.fromJson(discordBot.messages.getString(DCMessage.SUGGESTION_ALERT))
                ...
                Cooldown(player.uuid, name, discordBot.commandSettings.getInt(CommandSetting.MINECRAFT_SUGGESTION_COOLDOWN)).start()
            }
    }
}